...
_Note: Account "a" is the debit account (losing money), account "b" is the credit account (gaining money)_
...
_Note: For failed transactions, balances remain unchanged_
...
_Note: When instruction cannot be parsed at all, return null for all parseable fields (type, amount, currency, accounts, execute_by) and empty array for accounts. Only status, status_reason, and status_code should have values._
...
_Expected: Successfully debit 500 from N90394 and credit to N9122_
...
_Expected: Status "pending", balances unchanged_
...
_Expected: Successfully execute, currency returned as "GBP" (uppercase)_
...
_Expected: Execute immediately with status "successful" (AP00) since date is in the past_
...
_Expected: CU01 - Currency mismatch_
...
_Expected: AC01 - Insufficient funds_
...
_Expected: CU02 - Unsupported currency_
...
_Expected: AC02 - Debit and credit accounts cannot be the same_
...
_Expected: AM01 - Invalid amount_
...
_Expected: AC03 - Account not found_
...
_Expected: AM01 - Amount must be a positive integer (no decimals)_
...
_Expected: SY01 or SY03 - Missing required keywords or malformed instruction_
...
_Ready to demonstrate your skills? We look forward to seeing what you can build._
